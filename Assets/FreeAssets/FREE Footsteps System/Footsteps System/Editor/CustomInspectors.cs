...
namespace Footsteps
{
    ...
    public class FootstepsInspector : Editor
    {
        ...
        static void CreateSurfaceManager()
        {
            ...
            {
                GameObject database = Instantiate<GameObject>(Resources.Load<GameObject>(FootstepsSystemConstants.FOOTSTEPS_DATA_BASE));
                database.name = FootstepsSystemConstants.FOOTSTEPS_DATA_BASE;
            }
            else
        ...
        public override void OnInspectorGUI()
        {
            ...
            for (int i = 0; i < 13; i++) EditorGUILayout.Space();
