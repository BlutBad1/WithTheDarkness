...
namespace ScriptableObjectNS.Locking
{
    ...
    public class AvailableKeyData : KeyData
    {
        ...
        public AvailableKeyData(KeyData keyData)
         : base(keyData.IsGeneric, keyData.KeyName, keyData.GenericKeyName)
        {
            Amount = 1;
        }
    }
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(AvailableKeyData))]
    public class AvailableKeyDataDrawer : PropertyDrawer
    {
