...
{
    public class BulletHolesPoolsManager : MonoBehaviour
    {
        [SerializeField]
        public BulletHolePoolData[] pools;
        static BulletHolesPoolsManager instance;
        static public BulletHolesPoolsManager GetInstance()
        {
            return instance;
        }
        void Start()
        ...
        {
            BulletHolePoolData pool = Array.Find(pools, pool => pool.Name == objectType);
            if (pool == null)
            {
#if UNITY_EDITOR
        ...
        private void CreateObjects(BulletHolePoolData poolableObject, GameObject parent)
        {
