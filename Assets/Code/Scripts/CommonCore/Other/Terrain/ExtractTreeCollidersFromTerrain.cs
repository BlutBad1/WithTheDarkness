...
namespace TerrainNS
{
    ...
    public class ExtractTreeCollidersFromTerrain : MonoBehaviour
    {
        ...
        public void Extract()
        {
            ...
            GameObject newParent = new GameObject("Collisions");
            newParent.transform.parent = terrain.transform;
            ...
            for (int i = 0; i < terrain.terrainData.treePrototypes.Length; i++)
            {
                ...
                for (int j = 0; j < instances.Length; j++)
                {
                    ...
                    CapsuleCollider prefabCollider = UtilitiesNS.Utilities.GetComponentFromGameObject<CapsuleCollider>(tree.prefab, false);
                    if (!prefabCollider)
                        continue;
