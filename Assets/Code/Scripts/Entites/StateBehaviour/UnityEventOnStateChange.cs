...
namespace EntityNS.Base.StateBehaviourNS
{
    public class UnityEventOnStateChange : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public void OnBeforeSerialize()
        {
            if (StateNames == null || StateNames.Count == 0)
                StateNames = Enum.GetNames(typeof(EntityState)).ToList();
        }
        ...
        private void OnStateChangeEvent(EntityState oldState, EntityState newState)
        {
