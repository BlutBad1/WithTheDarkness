...
{
    public class EnemySpotTarget : SpotTarget
    {
        [SerializeField]
        protected EnemyCreature enemyCreature;
        [SerializeField]
        ...
        private bool DefineOpponentCondtions(Damageable damageable, ICreature creatureComponent) =>
                damageable != null && !damageable.IsDead && enemyCreature.DefineRelation(creatureComponent) == CreatureRelation.Enemy;
    }
}