...
namespace GameObjectsControllingNS
{
    ...
    {
        static float ObjectSupplyLevelPercentage(ObjectsSupplyLevel level)
        {
            switch (level)
            {
        ...
        public virtual ObjectsSupplyLevel ObjectSupplyLevel { get { return objectSupplyLevel; } set { objectSupplyLevel = value; } }
